...
class AppController extends GetxController {
  ...
  Future<void> getImageDetails() async {
    ...
    if (decodedImage != null) {
      imageLength.value = decodedImage.height.toString();
      imageWidth.value = decodedImage.height.toString();
  ...
  Future<String> initiatePayment(
    ...
    var body = {
      'merchant_id': id ?? PaymentCredential.merchantId,
      'merchant_key': key ?? PaymentCredential.merchantKey,
      'amount': cost,
  ...
  Future<void> savePaymentStatus(
    ...
    final paymentMethod = !isPaymentUsingPayFast.value ? 'wallet' : 'payFast';
    final bool cashMovement = isPaymentUsingPayFast.value;
    ...
    final Map<String, dynamic> taskManagementData = {
      ...
      'status': isFutureBookingBridge ? 'accepted' : 'progress',
    ...
    final Map<String, dynamic> transactionData = {
      ...
      'type': !isPaymentUsingPayFast.value ? 'wallet' : 'payFast',
  ...
  Future<void> pushCustomNotification({
    ...
    try {
      ...
      // Delete saved notification if FCM send fails
      await FirebaseFirestore.instance
          .collection('notifications')
          .doc(id)
          .delete();
